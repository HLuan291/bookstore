...
<?php foreach ($rows as $r): ?>
    <tr>
        <td><?= (int)$r['id'] ?></td>
        <td><?= htmlspecialchars($r['id_nguoidung'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
        <td><?= htmlspecialchars($r['ho_ten'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
        <td><?= htmlspecialchars($r['email'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
        <td><?= htmlspecialchars($r['so_dien_thoai'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
        <td><?= htmlspecialchars($r['ten_vai_tro'] ?? 'Chưa gán', ENT_QUOTES, 'UTF-8') ?></td>
        <td>
        ...
        <td class="actions">
            <!-- SỬA -->
            <a class="edit"
               href="edit.php?id_nguoidung=<?= urlencode($r['id_nguoidung']) ?>">
            ...
            <a class="delete"
               ...
               href="delete.php?id_nguoidung=<?= urlencode($r['id_nguoidung']) ?>">
