            ...
            <div class="right-box">
                ...
                <a href="index.php?page=cart" class="icon-btn" style="position: relative;">
                    ...
                    <span id="header-cart-count" class="cart-badge"
                        style="<?= ($total_qty_header > 0) ? 'display:flex;' : 'display:none;'; ?>">
                        <?= $total_qty_header ?>
                    </span>
                </a>

                <a href="../admin/index.php" class="icon-btn admin-btn" title="Trang quản trị">
                    <i class="fa-solid fa-user-gear"></i>
                </a>

                <?php if (isset($_SESSION['user'])): ?>
                    <a href="index.php?page=profile" class="icon-btn" title="Trang cá nhân">
                        <?= $header_avatar_html ?>
                    </a>
