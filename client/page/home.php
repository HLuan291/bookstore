<?php
// Đảm bảo có hàm db_fetch_all từ file functions.php
// Nếu biến $books chưa có thì query lại
if (!isset($books)) {
    ...
    <div class="book-slider">
        ...
        <div class="book-card">
            ...
            <div class="book-info">
                ...
                <a class="book-btn" href="javascript:void(0)" onclick="addToCart('<?= $b['id_sach'] ?>')">
                    Thêm vào giỏ
                </a>
            </div>
        </div>
